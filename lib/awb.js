...
Awb.prototype.map = function(handleElement = x => x) {
    return Awb.of(handleDOMTree(handleElement)(this.DOMTree));
};
...
Awb.prototype.chain = function(handleElement = x => Awb.of(x)) {
    return Awb.of(this.map(handleElement).join());
};
