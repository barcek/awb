...
const applyIfSubtrees = applyIfProp('children');
...
const reduceIfSubtrees = pipe(reduceSubtrees, applyIfSubtrees);

const handleDOMTree = handleElement => root =>
    pipe(handleElement, flattenIfDOMTree, reduceIfSubtrees(handleElement))(root);
