...
const HTMLTreeify = (str = '<div></div>') => pipe(createDocument, extractDOMTree)(str);

/*
    objTreeify
*/

const createElement = name => dom.window.document.createElement(name);
...
const objTreeify = ({ n = 'div', as = {}, t = '', ds = [] } = {}) =>
    pipe(createElement, setAttributes(as), setTextContent(t), addDescendants(ds))(n);
